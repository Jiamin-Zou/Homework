...
ApplicationRecord.transaction do
  ...
  Toy.create!(name: "teaser wand", toyable: cat1)
  Toy.create!(name: "catnip mouse", toyable: cat1)
  Toy.create!(name: "ball", toyable: cat2)
  Toy.create!(name: "ball", toyable: corgi1)
  Toy.create!(name: "chewy bone", toyable: corgi2)
  Toy.create!(name: "disc", toyable: corgi2)
